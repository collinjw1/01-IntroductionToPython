...
toto_turtle = rg.SimpleTurtle('turtle')
toto_turtle.pen = rg.Pen('green', 5)
toto_turtle.left(90)
toto_turtle.forward(100)
toto_turtle.left(45)
toto_turtle.backward(100)
toto_turtle.right(45)
toto_turtle.backward(150)
